...
from utils import plot_trajectory_curve
...
if __name__ == '__main__':
    ...
    from gym_push.envs.basic_env import SpaceCraftEnv
                
    env = gym.make('gym_push:basic-v0')
    N = 5
    batch_size = 20 #think about making this bigger, like 64
    n_epochs = 4
    alpha = 0.3
    ...
    for i in range(n_games):
        ...
        while not done:
            ...
            # rsc = [observation[27],observation[28],[observation[29]]
