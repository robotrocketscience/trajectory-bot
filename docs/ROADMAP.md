...
**Build N — next frontiers (open).** **R-N46 (next).** The pump+crank tour is discovered, realized, shown
...
launch-heuristic artifact (R-N44), and the Mars ARRIVAL characterized (R-N45: HOT — arrival v∞ 8–14 km/s,
a 17–35° crank node but ≥4.3 km/s from capture; cheap-to-REACH, hot-to-ARRIVE). Open work, in rough priority:
(a) actually CRANK at Mars — enumerate resonant Mars returns from the 8–14 km/s arrival and see whether the
17–35° ceiling realizes (as R-N38 did at Venus/Earth); (b) a Mars-capture budget round (what Δv-for-time buys a
bound Mars orbit); (c) a discrete crank-branch search for the R-N42 fraction; (d) broaden the Mars phasing
sweep beyond R-N43's two epochs. Other open frontiers: a single accumulating
