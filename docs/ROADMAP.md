...
**Build N — next frontiers (open).** **R-N40 (next): finish consolidating, then surface.** The pump+crank tour
is discovered, realized, AND now shown TYPICAL: R-N39's epoch sweep gives median final v∞ 15.31 (5/8 epochs at
15.1-17.8 km/s), with the honest failure modes mapped (2/8 no viable ≤8 launch — R-N30's phasing scarcity; 1/8
a pump-failure epoch). Open work, in rough priority: (a) the GATED PUBLIC-DOCS round — surface the R-N32→R-N39
discovery arc + the realized tour family in the README/website writeup with figures, ending in a gate: commit
for user go/nogo (the claim is now well-founded: "a typical viable epoch pumps v∞ ~4-8 → 15-18 km/s and cranks
toward ~97% of the analytic inclination ceiling, exactly ballistically, against real JPL ephemeris");
(b) DIFFERENTIABLE POLISH of the full pump+crank chain (R-N36's outer loop, sub-day line-searched steps);
(c) the outer-planet (Mars) handoff the exact-ballistic chains never afford (R-N32 H-N32c — likely needs the
